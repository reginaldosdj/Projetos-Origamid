...
// Mudar Aqui o e-mail
$email_envio = "reginaldosdj@pepisandbox.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = ""; // Senha do e-mail

$site_name = "Bikcraft"; // Nome do Site
$site_url = "www.bikcraft.com"; // URL do Site

$host_smtp = "smtp.pepipost.com"; // HOST SMTP Ex: smtp.domain.com.br
$host_port = "25"; // Porta do Host, geralmente 465 ou 587
